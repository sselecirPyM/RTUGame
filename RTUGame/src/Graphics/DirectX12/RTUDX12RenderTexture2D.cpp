...
void RTUDX12RenderTexture2D::AsDSV(DXGI_FORMAT format)
{
	//m_width = width;
	//m_height = height;
...
void RTUDX12RenderTexture2D::AsRTV(DXGI_FORMAT format)
{
	//m_width = width;
	//m_height = height;
	m_format = format;
...
void RTUDX12RenderTexture2D::AsRTVUAV(DXGI_FORMAT format)
{
	//m_width = width;
	//m_height = height;
	m_format = format;
